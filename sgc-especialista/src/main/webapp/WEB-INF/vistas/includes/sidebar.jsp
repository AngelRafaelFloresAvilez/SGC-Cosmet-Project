...
<%--
    Requiere en request: "paginaActiva" (dashboard|agenda|perfil) y opcionalmente "empleado".
    Se muestra como offcanvas de Bootstrap para que funcione igual en escritorio y movil,
    abierto con el boton de hamburguesa del topbar.
--%>
<div class="offcanvas offcanvas-start sgc-sidebar" tabindex="-1" id="sgcSidebar" aria-labelledby="sgcSidebarLabel">
    <div class="sgc-sidebar-header d-flex align-items-center gap-2">
        <div class="avatar-sidebar">
            <c:choose>
                <c:when test="${empleado != null && empleado.rutaFoto != null}">
        ...
        <div>
            <div class="fw-semibold" id="sgcSidebarLabel">
                <c:out value="${empleado != null ? empleado.nombreCompleto : 'Especialista'}" />
            </div>
